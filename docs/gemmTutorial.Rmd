...
#papaja::apa_table(out$covs, placement = "htb", caption = " Estimates of covariates", align = c("l", rep("r", 6)))
...
```{r model2RIMM, eval=F, echo = TRUE, include = TRUE, warning = FALSE}
plotIMM(result)
```
...
```{r model2RSS, eval=F, echo = TRUE, include = TRUE, warning = FALSE}
plotSS(result)
```
